...
if __name__ == "__main__":
    ...
    tweet = spark.read.json(
        "/home/cristian/Desktop/Data_Science/Projects/datapipeline/datalake/silver/twitter_aluraonline/tweet"
    )
    ...
    tweet.coalesce(1)\
        .write\
        .json("/home/cristian/Desktop/Data_Science/Projects/datapipeline/datalake/gold/twitter_insight_tweet")